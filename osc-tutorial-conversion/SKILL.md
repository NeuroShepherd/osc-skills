...
1. Apply kebab case to all file names and directories. For example, `someFolder/My_Tutorial.md` should be renamed to `some-folder/my-tutorial.md`. Files in the `assets` directory should also follow this convention.
